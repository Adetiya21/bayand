			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/sewa') ?>">Sewa</a>
						</li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/sewa') ?>">Data Pengajuan Sewa</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="main-body">
			...
			<div class="page-body">
				...
				<?php if ($sewa->status=="Diterima") { ?>
					<a href="<?= site_url('officer/sewa/cetak/'.$sewa->id) ?>" class="btn btn-primary btn-round" onclick="ExportPdf()"><span class="fa fa-eye"></span> Form Permohonan dan Perjanjian</a>
				...
				<?php } else if ($sewa->status=="Menunggu") { ?>
					<a href="<?= site_url('officer/sewa/cetak/'.$sewa->id) ?>" class="btn btn-primary btn-round disabled" onclick=""><span class="fa fa-eye"></span> Form Permohonan dan Perjanjian</a>
						...
						<div class="card-block" style="padding-left: 50px;padding-right: 50px;padding-top: 30px;">
							...
							<h4 class="sub-title" style="margin-bottom: 0;">PEMOHON SEWA</h4>
								<div class="form-group row">
									...
									<label class="col-sm-8 col-form-label" style="margin-bottom: -30px; font-size:0.9em;">: <b style="font-weight: bold;"><?= $key->nama ?></b></label>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" style="margin-bottom: -30px; font-size:0.9em;">Email</label>
									<label class="col-sm-8 col-form-label" style="margin-bottom: -30px; font-size:0.9em;">: <b style="font-weight: bold;"><?= $key->email ?></b></label>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" style="margin-bottom: -30px; font-size:0.9em;">No Telp</label>
									<label class="col-sm-8 col-form-label" style="margin-bottom: -30px; font-size:0.9em;">: <b style="font-weight: bold;"><?= $key->no_telp ?></b></label>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label" style="margin-bottom: -5px; font-size:0.9em;">Alamat Sekarang</label>
									<label class="col-sm-8 col-form-label" style="margin-bottom: -5px; font-size:0.9em;">: <b style="font-weight: bold;"><?= $key->alamat ?></b></label>
								</div>
							<?php }} ?>
							...
							<h4 style="margin-bottom: 0;" class="sub-title">PERIODE WAKTU dan HARGA</h4>
								...
								<div class="form-group row">
									...
									<label class="col-sm-8 col-form-label" style="margin-bottom: -5px; font-size:0.9em;">: <b style="font-weight: bold;">Rp. <?= $sewa->total+$sewa->t_biaya ?></b></label>
								</div>
							<h4 style="margin-bottom: 0;" class="sub-title">PRODUK JUAL</h4>
							<?php foreach ($pdft->result() as $key) {
							if ($sewa->id_pendaftar==$key->id) { ?>
							<label class="col-form-label">
								Objek sewa akan digunakan oleh pemohon sewa <b style="font-weight: bold"><?= $key->nama ?></b> untuk keperluan berdagang :</label>
								...
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-md-12">
											<?php foreach ($pdft->result() as $key) {
											if ($sewa->id_pendaftar==$key->id) { ?>
											<img style="width:100%; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" src="<?= base_url('assets/assets/img/ktp/') ?><?= $key->foto_ktp ?>" alt=" Foto Gerobak"/>
											<?php }} ?>
										</div>
									</div>
								</div>
