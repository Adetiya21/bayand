...
<script>
    ...
    function myFunction() {
        var x = document.getElementById("kd_toko");
			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/toko') ?>">Toko</a>
						</li>
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/toko') ?>">Daftar Toko</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>officer/toko/json", "type": "POST"},
        columns: [
        {
            "data": "kd_toko",
            "orderable": false
    ...
    function hapus(kd_toko)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("officer/toko/hapus/'+kd_toko+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(kd_toko)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("officer/toko/edit/'+kd_toko+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('officer/toko/tambah')?>";
        } else {
            url = "<?php echo site_url('officer/toko/update')?>";
        }
                        ...
                        <div class="row">
	                        <div class="col-md-12">
	                        	<div class="form-group">
		                            ...
		                            <input type="text" class="form-control" placeholder="Kode Toko" name="kd_toko" required maxlength="4" id="kd_toko" onkeyup="myFunction()"/>
