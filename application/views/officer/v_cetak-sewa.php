			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/sewa') ?>">Cetak Sewa</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="main-body">
			...
			<div class="page-body">
				...
				<?php if ($sewa->status=="Diterima") {?>
					...
					<a class="btn btn-primary btn-round" href="<?= site_url('officer/sewa/view/'.$sewa->id) ?>"><span class="fa fa-history"></span> Kembali</a>
