								...
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											...
											<h3 class="f-w-700 text-c-red"><?= $officer ?> Akun</h3>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									<div class="row align-items-center">
										<div class="col">
											...
											<h3 class="f-w-700 text-c-red"><?= $toko ?> Data Toko</h3>
										</div>
										<div class="col-auto">
											<i class="fas feather icon-layout bg-c-red"></i>
										</div>
									</div>
								</div>
							</div>
