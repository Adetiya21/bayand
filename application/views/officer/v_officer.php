			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/officer') ?>">Daftar officer</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    function hapus(nik)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("officer/officer/hapus/'+nik+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(nik)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("officer/officer/edit/'+nik+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('officer/officer/tambah')?>";
    } else {
        url = "<?php echo site_url('officer/officer/update')?>";
    }
                        ...
                        <div class="row">
	                        <div class="col-md-12">
	                        	<div class="form-group">
		                            <label >NIK</label>
		                            <input type="text" class="form-control" placeholder="NIK" name="nik" required maxlength="13" onkeypress='return check_int(event)' readonly />
		                            <span class="help-block"></span>
		                        </div>
                                <div class="form-group">
                                    <label >Password</label>
                                    <input type="password" class="form-control" placeholder="Password" name="password" required  readonly />
                                    <span class="help-block"></span>
                                </div>
	                        	<div class="form-group">
		                            <label >Nama officer</label>
		                            <input type="text" class="form-control" placeholder="Nama officer" name="nama" required readonly />
		                            <span class="help-block"></span>
		                        </div>
		                        <div class="form-group">
                                    <label >No. Telp</label>
