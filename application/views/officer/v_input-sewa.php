			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('officer/sewa/input') ?>">Input Sewa</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="page-body">
					<div class="card">
						...
						<div class="card-block">
							<div id="wizard">
								<section>
									<form class="wizard-form" id="example-advanced-form" action="<?= site_url('officer/sewa/proses') ?>" method="post" enctype="multipart/form-data">
										<?php $arb = array('enctype' => "multipart/form-data", );?>
				                        <?= form_open('officer/sewa/proses',$arb); ?>
										<h3> Data Diri </h3>
										<fieldset class="table table-responsive" style="width:100%;">
											...
											<div class="form-group row">
												...
												<div class="col-md-6 col-lg-8">
													<input id="email" name="email" type="email" class="required form-control" readonly/>
												</div>
											</div>
											<div class="form-group row">
												<div class="col-md-6 col-lg-4">
												...
												<div class="col-md-6 col-lg-8">
													<input id="no_telp" name="no_telp" type="number" class="form-control required phone" readonly/>
												</div>
											</div>
											<div class="form-group row">
												<div class="col-md-6 col-lg-4">
												...
												<div class="col-md-6 col-lg-8">
													<input id="alamat" name="alamat" type="text" class="form-control required" readonly/>
												</div>
											</div>
											<div class="form-group row">
												<div class="col-md-6 col-lg-4">
												...
												<div class="col-md-6 col-lg-8">
													<img id="foto_ktp" style="width:350px; height:210px; border-radius: 10px; box-shadow: 0px 0px 3px 0px;" alt=" Tidak Ada Foto KTP"/>
												</div>
											</div>
										</fieldset>
										...
										<fieldset class="table table-responsive" style="width:100%;">
											<div class="form-group row">
												...
												<div class="col-md-6 col-lg-8">
													<select class="form-control select2" name="kd_toko" style="width: 100%;"  onchange="changeValue(this.value)">
														...
														<?php 
														$jsArrayToko = "var dtToko = new Array();\n";    
														foreach ($toko->result() as $key) {
											                ?>
											                <option value="<?= $key->kd_toko ?>"><?= $key->nama_toko ?></option>
											                <?php $jsArrayToko .= "dtToko['" . $key->kd_toko . "'] = {
											                	alamat_toko:'" . addslashes($key->alamat_toko) . "',
											                	harga_sewa:'".addslashes($key->harga_sewa)."'
											                };\n"; ?>
										                <?php } ?>		
													</select>
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-6 col-lg-8 input-group">
											...
											<div class="form-group row">
												<div class="col-md-6 col-lg-4">
													<label for="" class="block">Produk Yang Dijual</label>
												</div>
												<div class="col-md-6 col-lg-8">
													<input id="" name="produk_jual" type="text" class="form-control required">
												</div>
											</div>	
										</fieldset>
										...
										<fieldset class="table table-responsive" style="width:100%;">
											<div class="form-group row">
												<div class="col-md-12 col-lg-12">
													...
													Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos perspiciatis eum consequuntur explicabo iusto nulla, aut nihil ipsam quod ipsa repellendus, qui iste expedita laborum perferendis placeat tempora maiores eligendi.
													<br><br>Pilih status pengajuan sewa secara langsung:
												</div>	
											</div>
											<div class="form-group row">
												<div class="col-md-6 col-lg-4">
													<label for="" class="block">Status Pengajuan</label>
												</div>
												<div class="col-md-6 col-lg-8">
