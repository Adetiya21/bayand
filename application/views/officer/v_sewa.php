    ...
    <div class="pcoded-inner-content"  style="margin-top: -20px;margin-bottom: -20px">
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                <a href="<?= site_url('officer/sewa/laporan') ?>" class="btn btn-danger btn-round" onclick="ExportPdf()"><span class="fa fa-file"></span> Laporan Sewa</a>
            </div>
        </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>officer/sewa/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    	...
    	if(confirm('Anda yakin ingin menghapus data?'))
      	{
            ...
            $.ajax({
              url : '<?php echo site_url("officer/sewa/hapus/'+id+'") ?>',
              type: "POST",
              dataType: "JSON",
    ...
    function edit(id)
    {
        ...
        $.ajax({
            url : '<?php echo site_url("officer/sewa/edit/'+id+'") ?>',
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('.modal-title').text('Edit Status Pengajuan'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('officer/sewa/tambah')?>";
        } else {
            url = "<?php echo site_url('officer/sewa/update')?>";
        }
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" value="<?= $this->session->userdata('nik') ?>" name="id_officer"/>
                        <div class="row">
                          <div class="col-md-12">
