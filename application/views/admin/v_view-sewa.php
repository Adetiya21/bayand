			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/sewa') ?>">Data Pengajuan Sewa</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="main-body">
			...
			<div class="page-body">
				...
				<?php if ($sewa->status=="Diterima") { ?>
					<a href="<?= site_url('admin/sewa/cetak/'.$sewa->id) ?>" class="btn btn-primary btn-round" onclick="ExportPdf()"><span class="fa fa-eye"></span> Form Permohonan dan Perjanjian</a>
				...
				<?php } else if ($sewa->status=="Menunggu") { ?>
					<a href="<?= site_url('admin/sewa/cetak/'.$sewa->id) ?>" class="btn btn-primary btn-round disabled" onclick=""><span class="fa fa-eye"></span> Form Permohonan dan Perjanjian</a>
