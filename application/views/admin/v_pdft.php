			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/pdft') ?>">Data Pendaftar</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript">
    ...
    var table = $('#compact').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "<?= base_url() ?>admin/pdft/json", "type": "POST"},
        columns: [
        {
            "data": "id",
            "orderable": false
    ...
    function hapus(id)
    {
        if(confirm('Anda yakin ingin menghapus data?'))
        {
            ...
            $.ajax({
                url : '<?php echo site_url("admin/pdft/hapus/'+id+'") ?>',
                type: "POST",
                dataType: "JSON",
    ...
    function edit(id)
    {
	    ...
	    $('.help-block').empty(); // clear error string
	    $.ajax({
	        url : '<?php echo site_url("admin/pdft/edit/'+id+'") ?>',
	        type: "GET",
	        dataType: "JSON",
	        success: function(data)
	        {
	            ...
	            $('.modal-title').text('Edit Data Pendaftar'); // Set title to Bootstrap modal title
	            if(data.foto_ktp)
	            {
	                ...
	                $('#photo-preview div').append('<br><input type="checkbox" name="remove_photo" value="'+data.foto_ktp+'"/> Remove old photo when saving'); // remove photo
	            }
	            else
	            {
    ...
    function view(id)
    {
	    ...
	    $.ajax({
	        ...
	        success: function(data)
	        {
	            ...
	            {
	                $('#label-photo').text('Change Photo'); // label photo upload
	                $('#photo-preview div').html('<img src="<?= base_url('assets/assets/img/ktp/') ?>'+data.foto_ktp+'" width="335px" height="200px" class="img-responsive">'); // show photo
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/pdft/tambah')?>";
    } else {
        url = "<?php echo site_url('admin/pdft/update')?>";
    }
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
	                        <div class="col-md-6">
	                        	<div class="form-group">
		                            <label >Nama</label>
		                            <input type="text" class="form-control" placeholder="Nama Sesuai KTP" name="nama" required/>
		                        ...
		                        <div class="form-group">
		                            <label >No. HP</label>
		                            <input type="text" class="form-control" placeholder="No.Telp" maxlength="13" name="no_telp" onkeypress='return check_int(event)'/>
		                            <span class="help-block"></span>
		                        </div>
		                        <div class="form-group">
		                            <label >Alamat</label>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="btn btn-default btn-file">
                              <input id="uploadImage" type="file" name="foto_ktp" onchange="PreviewImage();" /><i class="fa fa-paperclip"></i>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
	                        ...
	                        <div class="col-md-6">
		                        ...
		                        <div class="form-group">
		                            <label >No. HP</label>
		                            <input type="text" class="form-control" placeholder="No.Telp" name="no_telp" readonly/>
		                            <span class="help-block"></span>
		                        </div>
		                        <div class="form-group">
		                            <label >Alamat</label>
