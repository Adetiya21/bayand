						...
						<div class="nav-list">
							<div class="pcoded-inner-navbar main-menu">
								...
								<ul class="pcoded-item pcoded-left-item">								
									...
									<li class="toko">
										<a href="<?= site_url('admin/toko') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<li class="pdft pcoded-hasmenu">
										...
										<ul class="pcoded-submenu">
											<li class="data-pdft">
												<a href="<?= site_url('admin/pdft') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Data Pendaftar</span>
												</a>
											</li>
											<li class="input-pdft">
												<a href="<?= site_url('admin/pdft/input') ?>" class="waves-effect waves-dark">
									...
									<li class="sewa pcoded-hasmenu">
										...
										<ul class="pcoded-submenu">
											<li class="data-sewa">
												<a href="<?= site_url('admin/sewa') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Data Penyewaan</span>
												</a>
											</li>
											<li class="laporan-sewa">
												<a href="<?= site_url('admin/sewa/laporan') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Laporan Penyewaan</span>
												</a>
											</li>
											<li class="input-sewa">
												<a href="<?= site_url('admin/sewa/input') ?>" class="waves-effect waves-dark">
