			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item">
							<a href="<?= site_url('admin/sewa/input') ?>">Input Sewa</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="page-body">
					<div class="card">
						...
						<div class="card-block">
							<div id="wizard">
								<section>
									<form class="wizard-form" id="example-advanced-form" action="<?= site_url('admin/sewa/proses') ?>" method="post" enctype="multipart/form-data">
										<?php $arb = array('enctype' => "multipart/form-data", );?>
				                        <?= form_open('admin/sewa/proses',$arb); ?>
										<h3> Data Diri </h3>
