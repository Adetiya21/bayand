		...
		<div class="row align-items-end">
			<div class="col-lg-9">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h5>Profil</h5>
						<span>Lengkapi data diri anda agar memudahankan kami untuk mengkonfirmasi pengajuan sewa anda</span>
					</div>
				</div>
			</div>
			<div class="col-lg-3">
								...
								<div class="card-block" data-intro="This is Card body" data-step="2" data-hint="Hello step osne!">
			                        ...
			                        <?= form_open('home/edit_profil',$arb); ?>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input id="uploadImage" class="form-control" type="file" name="foto_ktp" onchange="PreviewImage();" value="<?= $profil->foto_ktp ?>" />
