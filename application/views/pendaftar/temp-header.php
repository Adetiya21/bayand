								...
								<ul class="pcoded-item pcoded-left-item">		
									<li class="profile">
										<a href="<?= site_url('home/profil/'.$this->session->userdata('id').'') ?>" class="waves-effect waves-dark">
											...
											<span class="pcoded-mtext">Profil Pendaftar</span>
										</a>
									</li>
									<li class="toko">
										<a href="<?= site_url('toko') ?>" class="waves-effect waves-dark">
											<span class="pcoded-micon">
									...
									<?php if ($profil->status=='Diterima') { ?>
									<li class="sewa disabled pcoded-hasmenu">
										...
										<ul class="pcoded-submenu">
											<li class="data-sewa">
												<a href="<?= site_url('sewa') ?>" class="waves-effect waves-dark">
													<span class="pcoded-mtext">Data Penyewaan</span>
												</a>
											</li>
											<li class="input-sewa">
												<a href="<?= site_url('sewa/input') ?>" class="waves-effect waves-dark">
