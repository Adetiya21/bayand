            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-6 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Login untuk dapat masuk kehalaman sewa teras Indomaret</p>
                        ...
                        <?= form_open('welcome/login'); ?>
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    Belum punya akun sewa? <a href="<?= site_url('welcome/form_daftar') ?>" class="text-danger">Ayo Daftar!!</a>
                                </div>
                            </div>
                        <?= form_close(); ?>
                    </div>
